...
from bor_solr_importer.bor_api.enums import InterestDetails
from bor_solr_importer.bor_api.services.bor_solr.doc_models import (
    DateRange,
    Entity,
    EntityRole,
    Interest,
...
from .address import get_btr_address
