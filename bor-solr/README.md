...
- if first time:
  - for a persistent index: `docker run -d -p 8883:8983 -v /<YOUR_PATH_TO_THIS_REPO>/beneficial-ownership/bor-solr/bitnami:/bitnami --name bor-solr-local bitnami/solr:9.0.0` (it will be available on port 8983)
